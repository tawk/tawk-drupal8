                        ...
                        <div id="fieldset_1">
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="col-xs-6 control-label ">
                                    ...
                                    ?>
                                    <input type="checkbox" class="checkbox" name="always_display" id="always_display" value="1" <?php echo ($checked) ? 'checked' : ''; ?> />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="col-xs-6 control-label">
                                    <?php if (!empty($display_opts->hide_oncustom)) : ?>
                                        ...
                                        <textarea class="form-control hide_specific" name="hide_oncustom" id="hide_oncustom" cols="30" rows="10"><?php foreach ($whitelist as $page) {
                                                                                                                                                        echo $page . "\r\n";
                                                                                                                                                    } ?></textarea>
                                    <?php else : ?>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="col-xs-6 control-label ">
                                    ...
                                    ?>
                                    <input type="checkbox" class="checkbox show_specific" name="show_onfrontpage" id="show_onfrontpage" value="1" <?php echo ($checked) ? 'checked' : ''; ?> />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="col-xs-6 control-label ">
                                    ...
                                    ?>
                                    <input type="checkbox" class="checkbox show_specific" name="show_oncategory" id="show_oncategory" value="1" <?php echo ($checked) ? 'checked' : ''; ?> />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="col-xs-6 control-label">
                                    <?php if (isset($display_opts->show_oncustom) && !empty($display_opts->show_oncustom)) : ?>
                                        ...
                                        <textarea class="form-control show_specific" name="show_oncustom" id="show_oncustom" cols="30" rows="10"><?php foreach ($whitelist as $page) {
                                                                                                                                                        echo $page . "\r\n";
                                                                                                                                                    } ?></textarea>
                                    <?php else : ?>
                        ...
                        <div id="fieldset_2">
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="col-xs-6 control-label">
                                    ...
                                    ?>
                                    <input type="checkbox" class="checkbox" name="enable_visitor_recognition" id="enable_visitor_recognition" value="1" <?php echo $checked ?> />
                                </div>
                            </div>
                        </div>
...
<?php
                                ...
                                public function setWidget($page, $widget)
                                {
                                    ...
                                    if (
                                        preg_match('/^[0-9A-Fa-f]{24}$/', $page) !== 1
